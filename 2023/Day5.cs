...
public class Day5 : Day<Day5.Garden>
{
    ...
    protected override bool Part2ParsedDifferently => true;         // for part 2, seeds are pairs (not individual ids), with the first being the start and the second the range.
